        ...
        z
          .object({
            ...
            parentId: z.optional(
              z
                .union([
                  z.string().describe("ID of the parent category"),
                  z.null(),
                ])
            ...
            nsfw: z.optional(
              z.boolean().describe("Whether the channel is NSFW"),
            ),
            lastMessageId: z.optional(
              z
                .union([
                  z.string().describe("ID of the last message sent"),
                  z.null(),
                ])
                .metadata({ def: { typeName: "ZodNullable" } }),
            ),
