...
// src/utils/ds-utils.ts
var ds_utils_exports = {};
__export(ds_utils_exports, {
  CustomSet: () => CustomSet
});

// src/utils/fn-utils.ts
var fn_utils_exports = {};
__export(fn_utils_exports, {
  isEqual: () => isEqual2,
  unique: () => unique
});
...
var _isPlainObject = /* @__PURE__ */ __name((x) => isPlainObject_default(x), "_isPlainObject");
...
var toString2 = /* @__PURE__ */ __name((message) => typeof message === "string" ? message : message == null ? void 0 : message.message, "toString");
...
// src/utils/other-utils.ts
var other_utils_exports = {};
__export(other_utils_exports, {
...
// src/utils/datestring-utils.ts
var datestring_utils_exports = {};
__export(datestring_utils_exports, {
...
// src/z/types/basetype/parseUtil.ts
...
var getParsedType = /* @__PURE__ */ __name((data) => {
  switch (typeof data) {
    ...
    case "object":
      ...
      if (
        // for fake promises
        data.then && typeof data.then === "function" && data.catch && typeof data.catch === "function"
      ) {
        return "promise";
      }
...
var __CircularDependencyError = class __CircularDependencyError extends Error {
...
var _ZodBaseTypeImpl = class _ZodBaseTypeImpl {
  constructor(def) {
  ...
  transform(transform) {
    return builders.downstream(
      ...
      { failFast: true }
      // keeps backward compatibility with previous transform implementation
    );
  }
  default(def) {
...
var _ZodAnyImpl = class _ZodAnyImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
  ...
  isEqual(schema) {
    return schema instanceof _ZodAnyImpl;
  }
};
...
var _ZodArrayImpl = class _ZodArrayImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    return new _ZodArrayImpl(__spreadProps(__spreadValues({}, this._def), {
  ...
  isEqual(schema) {
    ...
    if (!(schema instanceof _ZodArrayImpl)) {
      return false;
    }
    return (
...
var _ZodBigIntImpl = class _ZodBigIntImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
    this.min = this.gte;
    this.max = this.lte;
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodBigIntImpl)) {
      return false;
    }
  ...
  setLimit(kind, value, inclusive, message) {
    return new _ZodBigIntImpl(__spreadProps(__spreadValues({}, this._def), {
      checks: [
        ...this._def.checks,
        {
          kind,
...
var _ZodBooleanImpl = class _ZodBooleanImpl extends ZodBaseTypeImpl {
  _parse(input) {
    if (this._def.coerce) {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodBooleanImpl))
      return false;
...
var _ZodBrandedImpl = class _ZodBrandedImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    return new _ZodBrandedImpl(__spreadProps(__spreadValues({}, this._def), {
      type: this._def.type.dereference(defs)
    }));
  }
  getReferences() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodBrandedImpl))
      return false;
...
var _ZodCatchImpl = class _ZodCatchImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const { ctx } = this._processInputParams(input);
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodCatchImpl))
      return false;
  ...
  dereference(defs) {
    return new _ZodCatchImpl(__spreadProps(__spreadValues({}, this._def), {
...
var _ZodDateImpl = class _ZodDateImpl extends ZodBaseTypeImpl {
  _parse(input) {
    if (this._def.coerce) {
  ...
  _addCheck(check) {
    return new _ZodDateImpl(__spreadProps(__spreadValues({}, this._def), {
      checks: [...this._def.checks, check]
    }));
  }
  min(minDate, message) {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodDateImpl))
      return false;
    const thisChecks = new ds_utils_exports.CustomSet(this._def.checks);
    const thatChecks = new ds_utils_exports.CustomSet(schema._def.checks);
...
var _ZodDefaultImpl = class _ZodDefaultImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const { ctx } = this._processInputParams(input);
    let data = ctx.data;
  ...
  dereference(defs) {
    return new _ZodDefaultImpl(__spreadProps(__spreadValues({}, this._def), {
      innerType: this._def.innerType.dereference(defs)
    }));
  }
  getReferences() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodDefaultImpl))
      return false;
...
var _ZodDiscriminatedUnionImpl = class _ZodDiscriminatedUnionImpl extends ZodBaseTypeImpl {
  constructor(def) {
    const optionsMap = _ZodDiscriminatedUnionImpl._getOptionsMap(def.discriminator, def.options);
  ...
  dereference(defs) {
    ...
    return new _ZodDiscriminatedUnionImpl(__spreadProps(__spreadValues({}, this._def), {
      options
    }));
  }
  getReferences() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodDiscriminatedUnionImpl))
      return false;
...
var _ZodEnumImpl = class _ZodEnumImpl extends ZodBaseTypeImpl {
  _parse(input) {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodEnumImpl))
      return false;
...
var _ZodFunctionImpl = class _ZodFunctionImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
  ...
  dereference(defs) {
    ...
    return new _ZodFunctionImpl(__spreadProps(__spreadValues({}, this._def), {
      args,
      returns
    }));
  }
  ...
  isEqual(schema) {
    return schema instanceof _ZodFunctionImpl && this._def.args.isEqual(schema._def.args) && this._def.returns.isEqual(schema._def.returns);
  }
};
...
var _ZodIntersectionImpl = class _ZodIntersectionImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    return new _ZodIntersectionImpl(__spreadProps(__spreadValues({}, this._def), {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodIntersectionImpl))
      return false;
    const compare = /* @__PURE__ */ __name((a, b) => a.isEqual(b), "compare");
...
var _ZodLazyImpl = class _ZodLazyImpl extends ZodBaseTypeImpl {
  get schema() {
    return this._def.getter();
  }
  dereference(defs) {
    return new _ZodLazyImpl(__spreadProps(__spreadValues({}, this._def), {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodLazyImpl))
      return false;
...
var _ZodLiteralImpl = class _ZodLiteralImpl extends ZodBaseTypeImpl {
  _parse(input) {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodLiteralImpl))
      return false;
...
var _ZodMapImpl = class _ZodMapImpl extends ZodBaseTypeImpl {
  get keySchema() {
  ...
  dereference(defs) {
    ...
    return new _ZodMapImpl(__spreadProps(__spreadValues({}, this._def), {
      keyType,
      valueType
    }));
  }
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodMapImpl))
      return false;
...
var _ZodNaNImpl = class _ZodNaNImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const parsedType = this._getType(input);
    if (parsedType !== "nan") {
      const ctx = this._getOrReturnCtx(input);
  ...
  isEqual(schema) {
    return schema instanceof _ZodNaNImpl;
  }
};
...
var _ZodNativeEnumImpl = class _ZodNativeEnumImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodNativeEnumImpl))
      return false;
...
var _ZodNeverImpl = class _ZodNeverImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const ctx = this._getOrReturnCtx(input);
    addIssueToContext(ctx, {
      code: "invalid_type",
  ...
  isEqual(schema) {
    return schema instanceof _ZodNeverImpl;
  }
};
...
var _ZodNullImpl = class _ZodNullImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const parsedType = this._getType(input);
    if (parsedType !== "null") {
      const ctx = this._getOrReturnCtx(input);
  ...
  isEqual(schema) {
    return schema instanceof _ZodNullImpl;
  }
};
...
var _ZodNullableImpl = class _ZodNullableImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    return new _ZodNullableImpl(__spreadProps(__spreadValues({}, this._def), {
      innerType: this._def.innerType.dereference(defs)
    }));
  }
  getReferences() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodNullableImpl))
      return false;
...
var _ZodNumberImpl = class _ZodNumberImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
    this.min = this.gte;
    this.max = this.lte;
  ...
  setLimit(kind, value, inclusive, message) {
    return new _ZodNumberImpl(__spreadProps(__spreadValues({}, this._def), {
      checks: [
        ...this._def.checks,
        {
          kind,
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodNumberImpl))
      return false;
    const thisChecks = new ds_utils_exports.CustomSet(this._def.checks);
    const thatChecks = new ds_utils_exports.CustomSet(schema._def.checks);
    return thisChecks.isEqual(thatChecks);
...
var _ZodObjectImpl = class _ZodObjectImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
  ...
  dereference(defs) {
    ...
    return new _ZodObjectImpl(__spreadProps(__spreadValues({}, this._def), {
      shape: () => shape
    }));
  }
  getReferences() {
  ...
  clone() {
    ...
    const objSchema = new _ZodObjectImpl(__spreadProps(__spreadValues({}, this._def), {
      shape: () => newShape
    }));
    return objSchema;
  }
  ...
  strict(message) {
    ...
    return new _ZodObjectImpl(__spreadValues(__spreadProps(__spreadValues({}, this._def), {
      unknownKeys: "strict"
    }), message !== void 0 ? {
      errorMap: (issue, ctx) => {
        var _a, _b, _c, _d;
   ...
   */
  merge(merging) {
    const merged = new _ZodObjectImpl({
  ...
  keyof() {
    const keys2 = Object.keys(this.shape);
    return builders.enum(keys2);
  }
  isEqual(schema) {
    if (!(schema instanceof _ZodObjectImpl))
      return false;
...
var _ZodOptionalImpl = class _ZodOptionalImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    return new _ZodOptionalImpl(__spreadProps(__spreadValues({}, this._def), {
      innerType: this._def.innerType.dereference(defs)
    }));
  }
  getReferences() {
  ...
  _parse(input) {
    ...
    if (parsedType === "undefined") {
      return { status: "valid", value: void 0 };
    }
    return this._def.innerType._parse(input);
  }
  unwrap() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodOptionalImpl))
      return false;
    return this._def.innerType.isEqual(schema._def.innerType);
  }
  naked() {
...
var _ZodPipelineImpl = class _ZodPipelineImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    return new _ZodPipelineImpl(__spreadProps(__spreadValues({}, this._def), {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodPipelineImpl))
      return false;
...
var _ZodPromiseImpl = class _ZodPromiseImpl extends ZodBaseTypeImpl {
  unwrap() {
    return this._def.type;
  }
  dereference(defs) {
    return new _ZodPromiseImpl(__spreadProps(__spreadValues({}, this._def), {
      type: this._def.type.dereference(defs)
    }));
  }
  getReferences() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodPromiseImpl))
      return false;
    return this._def.type.isEqual(schema._def.type);
  }
  naked() {
...
var _ZodReadonlyImpl = class _ZodReadonlyImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
  ...
  dereference(defs) {
    return new _ZodReadonlyImpl(__spreadProps(__spreadValues({}, this._def), {
      innerType: this._def.innerType.dereference(defs)
    }));
  }
  getReferences() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodReadonlyImpl))
      return false;
    return this._def.innerType.isEqual(schema._def.innerType);
  }
  naked() {
...
var _ZodRecordImpl = class _ZodRecordImpl extends ZodBaseTypeImpl {
  get keySchema() {
    return this._def.keyType;
  }
  get valueSchema() {
  ...
  dereference(defs) {
    const keyType = this._def.keyType.dereference(defs);
    const valueType = this._def.valueType.dereference(defs);
    return new _ZodRecordImpl(__spreadProps(__spreadValues({}, this._def), {
      keyType,
      valueType
    }));
  }
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodRecordImpl))
      return false;
    if (!this._def.keyType.isEqual(schema._def.keyType))
      return false;
    if (!this._def.valueType.isEqual(schema._def.valueType))
...
var _ZodRefImpl = class _ZodRefImpl extends ZodBaseTypeImpl {
  dereference(defs) {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodRefImpl))
      return false;
...
var _ZodSetImpl = class _ZodSetImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    return new _ZodSetImpl(__spreadProps(__spreadValues({}, this._def), {
  ...
  isEqual(schema) {
    var _a, _b, _c, _d;
    if (!(schema instanceof _ZodSetImpl))
      return false;
...
var _ZodStringImpl = class _ZodStringImpl extends ZodBaseTypeImpl {
  _parse(input) {
    if (this._def.coerce) {
  ...
  _addCheck(check) {
    return new _ZodStringImpl(__spreadProps(__spreadValues({}, this._def), {
      checks: [...this._def.checks, check]
    }));
  }
  email(message) {
  ...
  datetime(options) {
    ...
    }, error_utils_exports.errToObj(options == null ? void 0 : options.message)));
  }
  regex(regex, message) {
    return this._addCheck(__spreadValues({
      kind: "regex",
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodStringImpl))
      return false;
    const thisChecks = new ds_utils_exports.CustomSet(this._def.checks);
    const thatChecks = new ds_utils_exports.CustomSet(schema._def.checks);
    return thisChecks.isEqual(thatChecks);
...
var _ZodSymbolImpl = class _ZodSymbolImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const parsedType = this._getType(input);
  ...
  isEqual(schema) {
    return schema instanceof _ZodSymbolImpl;
  }
};
__name(_ZodSymbolImpl, "ZodSymbolImpl");
var ZodSymbolImpl = _ZodSymbolImpl;

// src/z/types/effects/index.ts
var _ZodEffectsImpl = class _ZodEffectsImpl extends ZodBaseTypeImpl {
  innerType() {
  ...
  dereference(defs) {
    return new _ZodEffectsImpl(__spreadProps(__spreadValues({}, this._def), {
  ...
  _parse(input) {
    ...
    if (effect.type === "upstream") {
      ...
      if (ctx.common.async) {
        return Promise.resolve(processed).then(async (processed2) => {
          processed2 != null ? processed2 : processed2 = { status: "valid", value: ctx.data };
        ...
        processed != null ? processed : processed = { status: "valid", value: ctx.data };
    ...
    if (effect.type === "downstream") {
      if (ctx.common.async === false) {
        ...
        result != null ? result : result = { status: "valid", value: base.value };
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodEffectsImpl))
      return false;
...
var _ZodTupleImpl = class _ZodTupleImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    const items = this._def.items.map((item) => item.dereference(defs));
    const rest = this._def.rest ? this._def.rest.dereference(defs) : null;
    return new _ZodTupleImpl(__spreadProps(__spreadValues({}, this._def), {
      items,
      rest
    }));
  }
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodTupleImpl))
      return false;
...
var _ZodUndefinedImpl = class _ZodUndefinedImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const parsedType = this._getType(input);
    if (parsedType !== "undefined") {
      const ctx = this._getOrReturnCtx(input);
  ...
  isEqual(schema) {
    return schema instanceof _ZodUndefinedImpl;
  }
  mandatory() {
...
var _ZodUnionImpl = class _ZodUnionImpl extends ZodBaseTypeImpl {
  dereference(defs) {
    const options = this._def.options.map((option) => option.dereference(defs));
    return new _ZodUnionImpl(__spreadProps(__spreadValues({}, this._def), {
      options
    }));
  }
  getReferences() {
  ...
  isEqual(schema) {
    if (!(schema instanceof _ZodUnionImpl))
      return false;
    const compare = /* @__PURE__ */ __name((a, b) => a.isEqual(b), "compare");
    const thisOptions = new ds_utils_exports.CustomSet([...this._def.options], { compare });
    const thatOptions = new ds_utils_exports.CustomSet([...schema._def.options], { compare });
...
var _ZodUnknownImpl = class _ZodUnknownImpl extends ZodBaseTypeImpl {
  constructor() {
    super(...arguments);
    // required
    this._unknown = true;
  ...
  isEqual(schema) {
    return schema instanceof _ZodUnknownImpl;
  }
};
...
var _ZodVoidImpl = class _ZodVoidImpl extends ZodBaseTypeImpl {
  _parse(input) {
    const parsedType = this._getType(input);
    if (parsedType !== "undefined") {
      const ctx = this._getOrReturnCtx(input);
  ...
  isEqual(schema) {
    return schema instanceof _ZodVoidImpl;
  }
};
...
var downstreamType = /* @__PURE__ */ __name((schema, effect, params) => new ZodEffectsImpl(__spreadValues({
  schema,
  effect: { type: "downstream", effect, failFast: params == null ? void 0 : params.failFast },
  typeName: "ZodEffects"
...
// src/transforms/common/native.ts
...
var isOptionalSchema = /* @__PURE__ */ __name((s) => {
  var _a, _b;
  return s.anyOf !== void 0 && s.anyOf.length === 2 && s.anyOf.some((s2) => typeof s2 !== "boolean" && isUndefinedSchema(s2)) && ((_b = (_a = s["x-zui"]) == null ? void 0 : _a.def) == null ? void 0 : _b.typeName) === "ZodOptional";
}, "isOptionalSchema");
var isNullableSchema = /* @__PURE__ */ __name((s) => {
  var _a, _b;
  return s.anyOf !== void 0 && s.anyOf.length === 2 && s.anyOf.some((s2) => typeof s2 !== "boolean" && s2.type === "null") && ((_b = (_a = s["x-zui"]) == null ? void 0 : _a.def) == null ? void 0 : _b.typeName) === "ZodNullable";
}, "isNullableSchema");
var isUndefinedSchema = /* @__PURE__ */ __name((s) => {
  var _a, _b;
  return s.not === true && ((_b = (_a = s["x-zui"]) == null ? void 0 : _a.def) == null ? void 0 : _b.typeName) === "ZodUndefined";
}, "isUndefinedSchema");
var isUnknownSchema = /* @__PURE__ */ __name((s) => {
  var _a, _b;
  return !s.not && ((_b = (_a = s["x-zui"]) == null ? void 0 : _a.def) == null ? void 0 : _b.typeName) === "ZodUnknown";
}, "isUnknownSchema");
var isDiscriminatedUnionSchema = /* @__PURE__ */ __name((s) => {
  var _a, _b;
  return s.anyOf !== void 0 && ((_b = (_a = s["x-zui"]) == null ? void 0 : _a.def) == null ? void 0 : _b.typeName) === "ZodDiscriminatedUnion";
}, "isDiscriminatedUnionSchema");
var isExclusiveDiscriminatedUnionSchema = /* @__PURE__ */ __name((s) => {
  var _a, _b;
  return s.oneOf !== void 0 && ((_b = (_a = s["x-zui"]) == null ? void 0 : _a.def) == null ? void 0 : _b.typeName) === "ZodDiscriminatedUnion";
...
var _handleSet = /* @__PURE__ */ __name(({ items, minItems, maxItems }, toZui) => {
  let zodSet = setType(toZui(items));
  if (minItems) {
...
var _handleArray = /* @__PURE__ */ __name(({ minItems, maxItems, items }, toZui) => {
  let zodArray = arrayType(toZui(items));
...
function _fromJSONSchema(schema) {
  ...
  if (schema.description !== void 0) {
    const inner = _fromJSONSchema(__spreadProps(__spreadValues({}, schema), { description: void 0 }));
  ...
  if (schema.anyOf !== void 0) {
    ...
    if (isDiscriminatedUnionSchema(schema) && ((_d = (_c = schema["x-zui"]) == null ? void 0 : _c.def) == null ? void 0 : _d.discriminator)) {
      const { discriminator } = schema["x-zui"].def;
      const options2 = schema.anyOf.map(_fromJSONSchema);
  ...
  if (schema.oneOf !== void 0) {
    ...
    if (isExclusiveDiscriminatedUnionSchema(schema)) {
      const discriminator = ((_e = schema.discriminator) == null ? void 0 : _e.propertyName) || ((_g = (_f = schema["x-zui"]) == null ? void 0 : _f.def) == null ? void 0 : _g.discriminator);
      if (discriminator) {
        const options2 = schema.oneOf.map(_fromJSONSchema);
        return discriminatedUnionType(discriminator, options2);
      }
    }
    const options = schema.oneOf.map(_fromJSONSchema);
    return unionType(options);
  }
  if (schema.allOf !== void 0) {
    ...
    return intersectionType(zLeft, zRight);
  }
  schema.type;
...
var fromObject = /* @__PURE__ */ __name((obj, opts, isRoot = true) => {
  ...
  const applyOptions = /* @__PURE__ */ __name((zodType) => {
    ...
    if ((opts == null ? void 0 : opts.passtrough) && is.zuiObject(newType)) {
        ...
        case "object":
          if (Array.isArray(value)) {
            ...
            if (first === void 0 || first === null) {
              ...
              acc[key] = applyOptions(arrayType(fromObject(first, opts, false)));
...
function parseRecordDef(def, refs) {
  ...
  if (((_c = def.keyType) == null ? void 0 : _c._def.typeName) === ZodFirstPartyTypeKind.ZodString && ((_d = def.keyType._def.checks) == null ? void 0 : _d.length)) {
    ...
    ).reduce((acc, [key, value]) => key === "type" ? acc : __spreadProps(__spreadValues({}, acc), { [key]: value }), {});
...
function toJSONSchema(schema, options = {}) {
  ...
  switch (s.typeName) {
    case "ZodString":
      return zodStringToJsonString(s);
    case "ZodNumber":
      return zodNumberToJsonNumber(s);
    case "ZodNaN":
      throw new UnsupportedZuiToJSONSchemaError("ZodNaN");
    case "ZodBigInt":
      throw new UnsupportedZuiToJSONSchemaError("ZodBigInt", {
    ...
    case "ZodDate":
      throw new UnsupportedZuiToJSONSchemaError("ZodDate", {
    ...
    case "ZodVoid":
      throw new UnsupportedZuiToJSONSchemaError("ZodVoid");
    case "ZodArray":
      return zodArrayToJsonArray(s, (i) => toJSONSchema(i, opts));
    case "ZodObject":
      ...
      const properties = shape.map(([key, value]) => [key, value.mandatory()]).map(([key, value]) => [key, toJSONSchema(value, opts)]);
      return {
        type: "object",
        description: s.description,
    ...
    case "ZodDiscriminatedUnion":
      if (opts.discriminatedUnionStrategy === "oneOf") {
        const discriminator = opts.discriminator ? { propertyName: s.discriminator } : void 0;
        return {
          description: s.description,
          oneOf: s.options.map((option) => toJSONSchema(option, opts)),
          discriminator,
    ...
    case "ZodTuple":
      return zodTupleToJsonTuple(s, (i) => toJSONSchema(i, opts));
    case "ZodRecord":
      return {
        type: "object",
        description: s.description,
    ...
    case "ZodMap":
      throw new UnsupportedZuiToJSONSchemaError("ZodMap");
    case "ZodSet":
      return zodSetToJsonSet(s, (i) => toJSONSchema(i, opts));
    case "ZodFunction":
      throw new UnsupportedZuiToJSONSchemaError("ZodFunction");
    case "ZodLazy":
      throw new UnsupportedZuiToJSONSchemaError("ZodLazy");
    case "ZodLiteral":
    ...
    case "ZodEffects":
      throw new UnsupportedZuiToJSONSchemaError("ZodEffects");
    case "ZodNativeEnum":
      throw new UnsupportedZuiToJSONSchemaError("ZodNativeEnum");
    case "ZodOptional":
      return {
        description: s.description,
    ...
    case "ZodDefault":
      return __spreadProps(__spreadValues({}, toJSONSchema(s._def.innerType, opts)), {
        default: s._def.defaultValue()
      });
    case "ZodCatch":
      throw new UnsupportedZuiToJSONSchemaError("ZodCatch");
    case "ZodPromise":
      throw new UnsupportedZuiToJSONSchemaError("ZodPromise");
    case "ZodBranded":
      throw new UnsupportedZuiToJSONSchemaError("ZodBranded");
    case "ZodPipeline":
      throw new UnsupportedZuiToJSONSchemaError("ZodPipeline");
    case "ZodSymbol":
      throw new UnsupportedZuiToJSONSchemaError("ZodPipeline");
    case "ZodReadonly":
      return __spreadProps(__spreadValues({}, toJSONSchema(s._def.innerType, opts)), {
...
var undefinedSchema = /* @__PURE__ */ __name((def) => ({
  ...
  "x-zui": __spreadProps(__spreadValues({}, def == null ? void 0 : def["x-zui"]), { def: { typeName: "ZodUndefined" } })
}), "undefinedSchema");
...
var additionalPropertiesSchema = /* @__PURE__ */ __name((def, opts) => {
  if (def.unknownKeys === "passthrough") {
    return true;
  }
  ...
  if (schema instanceof KeyValue) {
    ...
    if (optionalValue) {
      ...
      if (is.zuiType(innerType) && !innerType.description && optionalValue.description) {
        innerType = innerType == null ? void 0 : innerType.describe(optionalValue.description);
      }
...
${value}`.trim();
    ...
    case "ZodNativeEnum":
      throw new UnsupportedZuiToTypescriptTypeError("ZodNativeEnum");
    case "ZodOptional":
...
function toTypescriptSchema(schema) {
  ...
  const dts = sUnwrapZod2(wrappedSchema);
  return dts;
}
...
function sUnwrapZod2(schema) {
  ...
  switch (s.typeName) {
    ...
    case "ZodArray":
      return `z.array(${sUnwrapZod2(s._def.type)})${generateArrayChecks(s._def)}${_addMetadata(s._def, s._def.type)}`;
    case "ZodObject":
      const props = mapValues_default(s.shape, sUnwrapZod2);
    ...
    case "ZodUnion":
      const options = s._def.options.map(sUnwrapZod2);
      return `z.union([${options.join(", ")}])${_addMetadata(s._def)}`.trim();
    case "ZodDiscriminatedUnion":
      const opts = s._def.options.map(sUnwrapZod2);
    ...
    case "ZodIntersection":
      const left = sUnwrapZod2(s._def.left);
      const right = sUnwrapZod2(s._def.right);
      return `z.intersection(${left}, ${right})${_addMetadata(s._def)}`.trim();
    case "ZodTuple":
      const items = s._def.items.map(sUnwrapZod2);
      return `z.tuple([${items.join(", ")}])${_addMetadata(s._def)}`.trim();
    case "ZodRecord":
      const keyType = sUnwrapZod2(s._def.keyType);
      const valueType = sUnwrapZod2(s._def.valueType);
      return `z.record(${keyType}, ${valueType})${_addMetadata(s._def)}`.trim();
    case "ZodMap":
      const mapKeyType = sUnwrapZod2(s._def.keyType);
      const mapValueType = sUnwrapZod2(s._def.valueType);
      return `z.map(${mapKeyType}, ${mapValueType})${_addMetadata(s._def)}`.trim();
    case "ZodSet":
      return `z.set(${sUnwrapZod2(s._def.valueType)})${generateSetChecks(s._def)}${_addMetadata(s._def)}`.trim();
    case "ZodFunction":
      const args = s._def.args.items.map(sUnwrapZod2);
      const argsString = args.length ? `.args(${args.join(", ")})` : "";
      const returns = sUnwrapZod2(s._def.returns);
      return `z.function()${argsString}.returns(${returns})${_addMetadata(s._def)}`.trim();
    case "ZodLazy":
      return `z.lazy(() => ${sUnwrapZod2(s._def.getter())})${_addMetadata(s._def)}`.trim();
    case "ZodLiteral":
    ...
    case "ZodEffects":
      throw new UnsupportedZuiToTypescriptSchemaError("ZodEffects");
    case "ZodNativeEnum":
      throw new UnsupportedZuiToTypescriptSchemaError("ZodNativeEnum");
    case "ZodOptional":
      return `z.optional(${sUnwrapZod2(s._def.innerType)})${_addMetadata(s._def, s._def.innerType)}`.trim();
    case "ZodNullable":
      return `z.nullable(${sUnwrapZod2(s._def.innerType)})${_addMetadata(s._def, s._def.innerType)}`.trim();
    case "ZodDefault":
      const defaultValue = unknownToTypescriptValue(s._def.defaultValue());
      return `z.default(${sUnwrapZod2(s._def.innerType)}, ${defaultValue})${_addMetadata(s._def, s._def.innerType)}`.trim();
    case "ZodCatch":
      throw new UnsupportedZuiToTypescriptSchemaError("ZodCatch");
    case "ZodPromise":
      return `z.promise(${sUnwrapZod2(s._def.type)})${_addMetadata(s._def, s._def.type)}`.trim();
    case "ZodBranded":
      throw new UnsupportedZuiToTypescriptSchemaError("ZodBranded");
    case "ZodPipeline":
      throw new UnsupportedZuiToTypescriptSchemaError("ZodPipeline");
    case "ZodSymbol":
      throw new UnsupportedZuiToTypescriptSchemaError("ZodSymbol");
    case "ZodReadonly":
      return `z.readonly(${sUnwrapZod2(s._def.innerType)})${_addMetadata(s._def, s._def.innerType)}`.trim();
    case "ZodRef":
...
var _addMetadata = /* @__PURE__ */ __name((def, inner) => {
  const innerDef = inner == null ? void 0 : inner._def;
...
var _maybeTitle = /* @__PURE__ */ __name((def, innerDef) => {
  var _a, _b;
  const title = (_a = def[zuiKey8]) == null ? void 0 : _a.title;
  if (!title) {
    return "";
  }
  if (innerDef && ((_b = innerDef[zuiKey8]) == null ? void 0 : _b.title) === title) {
    return "";
  }
...
var _maybeDisplayAs = /* @__PURE__ */ __name((def, innerDef) => {
  var _a, _b;
  const displayAs = (_a = def[zuiKey8]) == null ? void 0 : _a.displayAs;
  if (!displayAs) {
    return "";
  }
  if (innerDef && isEqual_default((_b = innerDef[zuiKey8]) == null ? void 0 : _b.displayAs, displayAs)) {
    return "";
  }
...
var _maybeDisabled = /* @__PURE__ */ __name((def, innerDef) => {
  var _a, _b;
  const disabled = (_a = def[zuiKey8]) == null ? void 0 : _a.disabled;
  if (!disabled) {
    return "";
  }
  if (innerDef && ((_b = innerDef[zuiKey8]) == null ? void 0 : _b.disabled) === disabled) {
    return "";
  }
...
var _maybeHidden = /* @__PURE__ */ __name((def, innerDef) => {
  var _a, _b;
  const hidden = (_a = def[zuiKey8]) == null ? void 0 : _a.hidden;
  if (!hidden) {
    return "";
  }
  if (innerDef && ((_b = innerDef[zuiKey8]) == null ? void 0 : _b.hidden) === hidden) {
    return "";
  }
...
var _maybePlaceholder = /* @__PURE__ */ __name((def, innerDef) => {
  var _a, _b;
  const placeholder = (_a = def[zuiKey8]) == null ? void 0 : _a.placeholder;
  if (!placeholder) {
    return "";
  }
  if (innerDef && ((_b = innerDef[zuiKey8]) == null ? void 0 : _b.placeholder) === placeholder) {
    return "";
  }
...
var _maybeSecret = /* @__PURE__ */ __name((def, innerDef) => {
  var _a, _b;
  const secret = (_a = def[zuiKey8]) == null ? void 0 : _a.secret;
  if (!secret) {
    return "";
  }
  if (innerDef && ((_b = innerDef[zuiKey8]) == null ? void 0 : _b.secret) === secret) {
    return "";
  }
  return ".secret()";
}, "_maybeSecret");
var _maybeSetMetadata = /* @__PURE__ */ __name((def, innerDef) => {
  ...
  const metadata = Object.entries((_a = def[zuiKey8]) != null ? _a : {}).filter(
  ...
  if (innerDef) {
    const innerMetadata = Object.entries((_b = innerDef[zuiKey8]) != null ? _b : {}).filter(
      ([key]) => !reservedKeys.includes(key)
    );
    if (isEqual_default(Object.fromEntries(metadata), Object.fromEntries(innerMetadata))) {
      return "";
    }
  }
