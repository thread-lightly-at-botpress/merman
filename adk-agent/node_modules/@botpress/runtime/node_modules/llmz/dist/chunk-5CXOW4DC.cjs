...
var _standalone = require('@babel/standalone'); var Babel = _interopRequireWildcard(_standalone);
...
function fixTSXUntilNoErrors(rawCode, maxAttempts = 50) {
  ...
  for (let attempt = 0; attempt < maxAttempts; attempt++) {
    try {
      _parser.parse.call(void 0, code, {
        sourceType: "module",
  ...
  visitor: {
    JSXText(path) {
      ...
      if (rawText !== modifiedText) {
        path.replaceWith(_types.jsxText.call(void 0, modifiedText));
        path.skip();
      }
    },
    JSXOpeningElement(path) {
      if (_types.isJSXIdentifier.call(void 0, path.node.name)) {
        path.node.name = _types.jsxIdentifier.call(void 0, path.node.name.name.toLowerCase());
      }
    },
    ...
    visitor: {
      Program(path) {
        ...
        const lineTrackingCall = (line) => {
          ...
          return _types.expressionStatement.call(void 0, _types.callExpression.call(void 0, _types.identifier.call(void 0, LineTrackingFnIdentifier), [_types.numericLiteral.call(void 0, line)]));
        };
        path.traverse({
          enter(path2) {
      ...
      Program(path) {
        ...
        path.traverse({
          enter(path2) {
            ...
            processComments(_nullishCoalesce(node.trailingComments, () => ( [])), (commentCall) => path2.insertAfter(commentCall));
            processComments(_nullishCoalesce(node.leadingComments, () => ( [])), (commentCall) => path2.insertBefore(commentCall));
            processComments(_nullishCoalesce(node.innerComments, () => ( [])), (commentCall) => path2.insertAfter(commentCall));
          }
        });
      }
    }
  ...
  return {
    visitor: {
      ...
      CallExpression(path) {
        ...
        const endStatement = (value) => _types.expressionStatement.call(void 0, 
          _types.callExpression.call(void 0, _types.identifier.call(void 0, ToolCallTrackerFnIdentifier), [
            _types.numericLiteral.call(void 0, callId),
            _types.stringLiteral.call(void 0, "end"),
            value
          ])
        );
        const isAsync = path.parentPath.isAwaitExpression();
        const tryBodyStatement = _types.blockStatement.call(void 0, [
          _types.expressionStatement.call(void 0, 
            _types.callExpression.call(void 0, _types.identifier.call(void 0, ToolCallTrackerFnIdentifier), [_types.numericLiteral.call(void 0, callId), _types.stringLiteral.call(void 0, "start")])
          ),
          _types.variableDeclaration.call(void 0, "const", [
            _types.variableDeclarator.call(void 0, 
              _types.identifier.call(void 0, ToolTrackerRetIdentifier),
              isAsync ? _types.awaitExpression.call(void 0, path.node) : path.node
            )
          ]),
          endStatement(_types.identifier.call(void 0, ToolTrackerRetIdentifier)),
          _types.returnStatement.call(void 0, _types.identifier.call(void 0, ToolTrackerRetIdentifier))
        ]);
        if (!lval) {
          if (path.getSource().trim().length) {
            const newError = _types.identifier.call(void 0, "__newError");
            const newCall2 = _types.callExpression.call(void 0, 
              _types.arrowFunctionExpression.call(void 0, 
                [],
                // params
                _types.blockStatement.call(void 0, [
                  _types.tryStatement.call(void 0, 
                    tryBodyStatement,
                    _types.catchClause.call(void 0, 
                      _types.identifier.call(void 0, "err"),
                      _types.blockStatement.call(void 0, [
                        endStatement(_types.identifier.call(void 0, "err")),
                        _types.variableDeclaration.call(void 0, "const", [
                          _types.variableDeclarator.call(void 0, 
                            newError,
                            _types.newExpression.call(void 0, _types.identifier.call(void 0, "Error"), [
                              _types.memberExpression.call(void 0, _types.identifier.call(void 0, "err"), _types.identifier.call(void 0, "message"))
                            ])
                          )
                        ]),
                        _types.expressionStatement.call(void 0, 
                          _types.assignmentExpression.call(void 0, 
                            "=",
                            _types.memberExpression.call(void 0, newError, _types.identifier.call(void 0, "stack")),
                            _types.binaryExpression.call(void 0, 
                              "+",
                              _types.memberExpression.call(void 0, _types.identifier.call(void 0, "err"), _types.identifier.call(void 0, "stack")),
                              _types.binaryExpression.call(void 0, 
                                "+",
                                _types.stringLiteral.call(void 0, "\n"),
                                _types.memberExpression.call(void 0, newError, _types.identifier.call(void 0, "stack"))
                              )
                            )
                          )
                        ),
                        _types.throwStatement.call(void 0, newError)
                      ])
                    )
                  )
                ]),
        ...
        const newCall = _types.callExpression.call(void 0, 
          _types.arrowFunctionExpression.call(void 0, 
            [],
            // params
            _types.blockStatement.call(void 0, [
              _types.tryStatement.call(void 0, 
                ...
                _types.catchClause.call(void 0, 
                  ...
                  _types.blockStatement.call(void 0, [
                    endStatement(_types.identifier.call(void 0, "err")),
                    _types.throwStatement.call(void 0, 
                      _types.newExpression.call(void 0, _types.identifier.call(void 0, "Error"), [_types.memberExpression.call(void 0, _types.identifier.call(void 0, "err"), _types.identifier.call(void 0, "message"))])
                    )
                  ])
                )
              )
...
var variableTrackingPlugin = (variables = /* @__PURE__ */ new Set()) => function({ types: t3 }) {
  ...
  const trackVariable = (variableName) => {
    ...
    trackingStatements.push(
      _types.expressionStatement.call(void 0, 
        _types.callExpression.call(void 0, _types.identifier.call(void 0, VariableTrackingFnIdentifier), [
          _types.stringLiteral.call(void 0, variableName),
          _types.arrowFunctionExpression.call(void 0, [], _types.callExpression.call(void 0, _types.identifier.call(void 0, "eval"), [_types.stringLiteral.call(void 0, variableName)]))
        ])
      )
    );
  };
      ...
      ArrowFunctionExpression(path) {
        ...
        if (trackingStatements.length) {
          ...
          if (body.isBlockStatement()) {
            ...
            const newBody = _types.blockStatement.call(void 0, [...trackingStatements, _types.returnStatement.call(void 0, body.node)]);
...
function getCompiledCode(code, traces = []) {
  try {
    ...
    traces.push({
      ...
      message: _nullishCoalesce((err == null ? void 0 : err.message), () => ( "Unknown error")),
      code,
      started_at: Date.now()
    });
...
var handleErrorNode = (err, code, consumer, traces, variables, _lines_executed, currentToolCall) => {
  ...
  const matches = [...stackTrace.matchAll(regex)].map((x) => {
    ...
    const line = _nullishCoalesce(originalLine.line, () => ( Number(x[1])));
    const actualLine = _nullishCoalesce(lines[line - LINE_OFFSET], () => ( ""));
    const whiteSpacesCount = actualLine.length - actualLine.trimStart().length;
