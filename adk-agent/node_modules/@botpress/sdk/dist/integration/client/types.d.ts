...
type GetOrCreateMessageResponse<TIntegration extends common.BaseIntegration, TMessage extends keyof EnumerateMessages<TIntegration> = keyof EnumerateMessages<TIntegration>> = utils.Merge<Awaited<Res<client.Client['getOrCreateMessage']>>, {
    message: utils.Merge<Awaited<Res<client.Client['getOrCreateMessage']>>['message'], utils.Cast<EnumerateMessages<TIntegration>[TMessage], object>>;
}>;
